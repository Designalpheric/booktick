    ...
    <>
      <div className="min-h-screen bg-gray-50 pt-[70px] xs:pt-[72px] sm:pt-[82px] lg:pt-[84px] pb-20 sm:pb-0">
        ...
        <div className="bg-white border-b border-gray-100">
          <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-8 lg:px-8 2xl:px-12 py-3 flex items-center gap-2 text-sm text-gray-500">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 lg:p-6 lg:sticky lg:top-24">
                ...
                <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-3 lg:flex lg:flex-col lg:gap-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 sm:py-3 lg:py-3.5 px-3 rounded-full transition-colors text-sm sm:text-sm lg:text-base"
                  >
                  ...
                  <a
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#1ebe5d] text-white font-bold py-3 sm:py-3 lg:py-3.5 px-3 rounded-full transition-colors text-sm sm:text-sm lg:text-base"
                  >
                  ...
                  <a
                    ...
                    className="w-full flex items-center justify-center gap-2 border border-gray-200 hover:border-orange-400 text-gray-700 hover:text-orange-600 font-semibold py-3 px-3 rounded-full transition-colors text-sm sm:text-sm lg:text-base"
                  >
      ...
      <div className="fixed bottom-0 left-0 right-0 sm:hidden z-40 bg-white border-t border-gray-100 shadow-[0_-4px_16px_rgba(0,0,0,0.08)] px-4 py-3 flex items-center justify-between gap-3">
        ...
        <button
          onClick={() => setEnquiryOpen(true)}
          className="shrink-0 flex items-center gap-2 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white font-bold py-2.5 px-5 rounded-full transition-colors text-sm"
        >
